"""
Recursive Raymarching with multiple objects and reflections, with a cubemap as environment.
Arcball interaction, mouse wheel zoom.
"""
def preload():
    global my_shader
