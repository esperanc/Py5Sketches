...
const vec3 defEye = vec3(0,0, 6); // Default eye position
...
void main( )
{
    ...
    vec3 p = eye+dist*dir;
    // cubemap color needs to flip x for left-handed coord system
    vec3 color = textureCube(uCubemap, dir*vec3(-1,1,1)).rgb; 
